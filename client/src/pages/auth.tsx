...
export default function AuthPage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-[radial-gradient(circle_at_top,_hsl(var(--primary)/0.12),_transparent_32%),linear-gradient(180deg,hsl(var(--background)),hsl(var(--muted)/0.55))] px-3 py-8 sm:px-4 sm:py-10">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-56 bg-[radial-gradient(circle_at_top,_hsl(var(--secondary)/0.22),_transparent_48%)]" />
              ...
              <div className="rounded-[30px] border border-primary/10 bg-[linear-gradient(180deg,hsl(var(--background)),hsl(var(--muted)/0.35))] p-5 shadow-[0_24px_70px_hsl(var(--foreground)/0.05)] sm:p-6">
                <div className="space-y-5">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      toast({
                        ...
                        description: "We’ll take you to the right tutor page automatically.",
                      });
                  ...
                  <div className="rounded-[22px] border border-primary/10 bg-primary/5 px-4 py-3 text-sm text-primary shadow-[inset_0_1px_0_hsl(var(--background)/0.95)]" data-testid="text-create-profile-redirect">
                    New tutors start on profile creation. Returning tutors either resume the exact missed onboarding step or go straight to their live personal dashboard.
                  </div>
                </div>
              </div>
